...
Group.new('LspSagaCodeActionContent',      c.grey_500, c.none, no)
Group.new('LspSagaCodeActionTitle',        c.grey_500, c.none, no)
Group.new('LspSagaCodeActionTruncateLine', c.grey_500, c.none, no)
Group.new('LspSagaDiagnosticHeader',       c.grey_500, c.none, no)
Group.new('LspSagaDiagnosticTruncateLine', c.grey_500, c.none, no)
Group.new('LspSagaDocTruncateLine',        c.grey_500, c.none, no)
Group.new('LspSagaFinderSelection',        c.white,    c.blue_700, no)
Group.new('LspSagaRenamePromptPrefix',     c.grey_500, c.none, no)
Group.new('LspSagaShTruncateLine',         c.grey_500, c.none, no)
Group.new('LspSagaCodeActionBorder',       c.blue_grey_600, c.blue_grey_50, no)
Group.new('LspSagaDefPreviewBorder',       c.blue_grey_600, c.blue_grey_50, no)
Group.new('LspSagaDiagnosticBorder',       c.blue_grey_600, c.blue_grey_50, no)
Group.new('LspSagaHoverBorder',            c.blue_grey_600, c.blue_grey_50, no)
Group.new('LspSagaLspFinderBorder',        c.blue_grey_600, c.blue_grey_50, no)
Group.new('LspSagaRenameBorder',           c.blue_grey_600, c.blue_grey_50, no)
Group.new('LspSagaSignatureHelpBorder',    c.blue_grey_600, c.blue_grey_50, no)
Group.new('LspLinesDiagBorder',            c.blue_grey_600, c.blue_grey_50, no)
Group.new('SagaShadow',                    c.grey_500, c.grey_100, no)
